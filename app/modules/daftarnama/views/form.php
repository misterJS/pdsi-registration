		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content" id="myTabContent">
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nis" value="<?=set_value('nis', @$nis)?>"/>
					</div>
				</div>
				<div class="form-group row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">NISN</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nisn" value="<?=set_value('nisn', @$nisn)?>" required="required"/>
					</div>
				</div>
				<div class="form-group row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Nama Orangtua</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nama_orangtua" value="<?=set_value('nama_orangtua', @$nama_orangtua)?>" required="required"/>
						<small>Nama ayah atau ibu</small>
					</div>
				</div>
				<div class="form-group row mb-3">
